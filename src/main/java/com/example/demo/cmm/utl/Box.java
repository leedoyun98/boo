...
public class Box<T> {
    ...
    public boolean	containsValue(String value) {
        return box.containsValue(value);
    }
    ...
    public void	putAll(List<String> l , Vector<T> v) {
    ...
    public List<T> listValues(String key){
        return (List<T>) box.get(key);
    }
    @SuppressWarnings("unchecked")
    public Set<T> setValues(String key){
        return (Set<T>) box.get(key);
    }
