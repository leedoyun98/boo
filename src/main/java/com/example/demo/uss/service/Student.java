...
public class Student {
	...
	public Student(String userid, String password, String name, String birthday, String gender, String regDate,
	...
	@Builder
	private Student(int mgrNum, String userid, String password, String name, String birthday, String regDate,
					String profileImage){
		this.userid = userid;
		this.password = password;
		this.name = name;
